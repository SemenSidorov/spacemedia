...
$APPLICATION->SetTitle("<span>Space</span> media");
?>
...
<section class="section statistics">
    ...
    <div class="statistics-item">
        <p class="statistics__count">70<span class="plus">+</span></p>
        <p class="text-bigger">digital стратегий вместе с комплексной аналитикой</p>
    </div>
    <div class="statistics-item">
        <p class="statistics__count">200<span class="plus">+</span></p>
        <p class="text-bigger">проектов с таргетированной рекламой</p>
    </div>
    <div class="statistics-item">
        <p class="statistics__count">100<span class="plus">+</span></p>
        <p class="text-bigger">медийных кампаний</p>
    </div>
    <div class="statistics-item">
        <p class="statistics__count">50<span class="plus">+</span></p>
        <p class="text-bigger">известных брендов</p>
	</div>
	-->
</section>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "main.portfolio"
	),
	false
);?>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "main.offers",
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "N",
		"DISPLAY_DATE" => "Y",
		"DISPLAY_NAME" => "Y",
